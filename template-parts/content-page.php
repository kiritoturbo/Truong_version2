...
<main class="main">
  <section class="hero">
    <div class="hero-content">
      <h1 class="heading animated wow slideInLeft animate__animated animate__delay-1s animate__fadeInTopLeft">
        <?php echo esc_html(get_field('dong_so_1_chu_to', 'option')); ?>
      </h1>
      <p class=" description animate__animated animate__delay-1s animate__lightSpeedInLeft">
        <?php echo esc_html(get_field('dong_so_2_chu_to', 'option')); ?>
      </p>
      <a href="" class="link animate__animated animate__delay-2s animate__zoomInUp"><?php echo get_field('button_tim_hieu_them', 'option'); ?></a>
    ...
    <div class="hero-img animate__animated animate__delay-1s animate__fadeInDown ">
  ...
  <section class="activity">
    ...
    <div class="activity-list">
      <div id="testprogressbar" class="activity-item animated wow slideInLeft animate__animated animate__delay-1s animate__fadeInTopLeft">
        <div class="wrapper">
          <div class="item-top">
      ...
      <div class="activity-item animated wow slideInLeft animate__animated animate__delay-1s animate__fadeInTopRight">
        <div class="wrapper">
          <div class="item-top">
      ...
      <div class="activity-item animated wow slideInLeft animate__animated animate__delay-1s animate__fadeInBottomLeft">
        <div class="wrapper">
          <div class="item-top">
      ...
      <div class="activity-item animated wow slideInLeft animate__animated animate__delay-1s  animate__fadeInBottomRight">
        <div class="wrapper">
          <div class="item-top">
